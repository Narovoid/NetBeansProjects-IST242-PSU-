...
class PointTester{
    public static void main(String[] arguments) {
        ...
        System.out.println("The 2D point is now at ("+ location1.x + ", " +
                + location1.y + ")" );
        System.out.println("It's being moved -15 units on both the x "
        +"and y axes.");
        location1.translate(-15,-15);
        ...
        System.out.println("The 3D point is now at ("+ location2.x + ", " +
                + location2.y + ", " + location2.z +")" );
        System.out.println("It's being moved 5 units on each of the x "
        +"y and z axes.");
        location2.translate(-5,-5,-5);
